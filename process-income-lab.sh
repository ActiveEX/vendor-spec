...
CARD_ID="698d4fdff164d25aa94f5486"
VENDOR_NAME="Income Lab"
SLUG="income-lab"
FILE_PATH="/data/.openclaw/workspace/vendor-research/income-lab.md"
GITHUB_PATH="vendors/income-lab.md"
...
SUMMARY="✅ Research complete\n- File: vendors/income-lab.md\n- Integrations: $INTEGRATION_COUNT\n- New vendors discovered: Kwanti, Nitrogen, Betterment for Advisors, Advyzon, Orion\n- Cost: MiMo-V2-Flash (~$0.001)"
curl -s -X POST "https://api.trello.com/1/cards/${CARD_ID}/actions/comments" \
  --data-urlencode "key=${TRELLO_KEY}" \
  --data-urlencode "token=${TRELLO_TOKEN}" \
  --data-urlencode "text=$SUMMARY" > /dev/null

echo "Done. Income Lab moved to Complete."